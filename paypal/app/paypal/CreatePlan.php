...
dd($output);
     ...
     */
    protected function PaymentDefination(): PaymentDefinition
    {
    ...
    protected function merchantPreferences(): MerchantPreferences
    {
        ...
        $merchantPreferences->setReturnUrl(config('services.paypal.urls.executeAgreement.success'))
            ->setCancelUrl(config('services.paypal.urls.executeAgreement.failure'))
